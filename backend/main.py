...
async def upload_image(
    ...
    # Generate caption & classify image automatically
    caption = generate_caption(filepath)
    predicted_category = classify_image(filepath)

    # Handle "other category"
    allowed_categories = ["food", "fashion", "travel", "tech", "nature"]
    ...
    return JSONResponse({
        ...
        "caption": caption,
        "original_image": f"http://localhost:8000/uploads/{safe_filename}",
        "processed_image": f"http://localhost:8000/uploads/processed_{safe_filename}",
    })
